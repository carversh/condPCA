...
if (method != "cNMF"){
    ...
    if (is.na(flag_sim_100_cts)){
        ...
        write.table(df, file = "/data/gusev/USERS/scarver/Gusev_Lab/Simulation/Gamma-Poisson/output.txt", append = TRUE, quote = FALSE, sep = " ", row.names = FALSE, col.names = FALSE)
