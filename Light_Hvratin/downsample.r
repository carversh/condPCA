...
if (method == "PCA"){
    ...
    write.table(unscaled_data, file=glue("/data/gusev/USERS/scarver/Light_Hvratin/cNMF_final/{method}_{num_cells}_{seed}_{data_param}_{dim}_{vargenes}.tab"), append = FALSE, sep = "\t", dec = ".",row.names = TRUE, col.names = TRUE)
}
...
write.table(df, file = "/data/gusev/USERS/scarver/Light_Hvratin/finished_downsampling_scripts.txt", append = TRUE, quote = FALSE, sep = " ", row.names = FALSE,col.names = FALSE)
